        ...
        builder: (context, child) => new Stack(
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: MyAppTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      MyAppTheme.nearlyDarkBlue.withOpacity(0.2),
                      MyAppTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: MyAppTheme.nearlyDarkBlue,
                  gradient: LinearGradient(
                    colors: [
                      MyAppTheme.nearlyDarkBlue.withOpacity(0.4),
                      MyAppTheme.nearlyDarkBlue
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: MyAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: MyAppTheme.white.withOpacity(
